...
appFactory.factory('dataService', function ($http, $q, $interval, $filter, $location, $window, deviceService, myCache, cfg) {
    ...
    return({
        ...
        loadJoinedZigbeeData: loadJoinedZigbeeData,
    ...
    function loadZigbeeApiData(noCache) {
        ...
        return $http({
            ...
            // something went wrong
            // do not return error here to still allow showing the list of Zigbee Bindings
            // return $q.reject(response);
        });
    }

    /**
     * Get updated data and join with ZigbeeData
     */
    function  loadJoinedZigbeeData() {
        // console.trace('call');
