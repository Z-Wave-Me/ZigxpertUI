            ...
            angular.forEach(device.endpoints, function(endpoint, endpointId) {
                ...
                if (angular.isObject(meters)) {
                    angular.forEach(meters.data, function(meter, key) {
                        // Zigbee differentiates different meter types and different meter scales.
                        ...
                        if (ZigbeeAPIData.devices[k].endpoints[endpointId].clusters[0x32].data.version.value < 2
                                || !ZigbeeAPIData.devices[k].endpoints[endpointId].clusters[0x32].data.resettable.value) {
                            obj['urlToReset'] = null;
                        } else {
