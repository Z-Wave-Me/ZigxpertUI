...
appController.controller('ExpertConfigController', function ($scope, $timeout,$interval, $location, cfg,dataService,deviceService) {
    ...
    $scope.loadSettings = function() {
        $scope.expertConfig.input = cfg.zigbeecfg;
    };
    $scope.loadSettings();
...
appController.controller('DataHolderController', function ($scope, $timeout,$interval, $location, cfg,dataService,deviceService) {
    ...
    function setControllerData(ZigbeeAPIData) {
       $scope.dataHolder.controller.homeName = ZigbeeAPIData.controller.data.homeName.value || cfg.controller.homeName;
       $scope.dataHolder.controller.homeNotes = ZigbeeAPIData.controller.data.homeNotes.value.replace(/<br>/g, '\n' );
    }
