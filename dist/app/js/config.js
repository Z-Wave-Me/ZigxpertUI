...
var config_data = {
	'cfg': {
		...
		'dongle': 'zbee', // Default dongle
		'dongle_list': [], // Dongle list

		// APIs with dongle
		'update_url': '/ZigbeeAPI/Data/', // Url for update (refresh data)
		'store_url': '/ZigbeeAPI/Run/', // Url for store data
		'restore_url': '/ZigbeeAPI/Restore', // Url to restore backup
		'queue_url': '/ZigbeeAPI/InspectQueue', // Url for inspect queue
		'fw_update_url': '/ZigbeeAPI/FirmwareUpdate', // Url for Firmware Update
		'zme_bootloader_upgrade': '/ZigbeeAPI/ZMEBootloaderUpgrade', // ZME Bootloader upgrade url
		'zme_firmware_upgrade': '/ZigbeeAPI/ZMEFirmwareUpgrade', // ZME Firmware upgrade url
		'upload_bootloader': '/ZigbeeAPI/ZMEBootloaderUpgrade', // Bootloader upload api
		'upload_firmware': '/ZigbeeAPI/ZMEFirmwareUpgrade', // Firmware upload api
		'license_load_url': '/ZigbeeAPI/ZMELicense', // Url to load new license
		'stat_url': '/ZigbeeAPI/CommunicationStatistics', // Url to statistics
		'postfixget_url': '/ZigbeeAPI/PostfixGet', // Postfix GET
		'postfixadd_url': '/ZigbeeAPI/PostfixAdd', // Postfix Add
		'postfixremove_url': '/ZigbeeAPI/PostfixRemove', // Postfix Remove
		'checklinks': '/ZigbeeAPI/CheckAllLinks', // check link health
		'zniffer_url': '/ZigbeeAPI/Zniffer', // Zniffer
		'zniffer_set_promisc_url': '/ZigbeeAPI/Zniffer/SetPromisc/', // Zniffer Set Promiscuous Mode
		'communication_history_url': '/ZigbeeAPI/CommunicationHistory', // Communication History
		'rssi_chart': '/ZigbeeAPI/RSSIGet', // chart of rssi channels 1 and 2
		'call_all_nif': '/ZigbeeAPI/CallForAllNIF', // Call niff for all devices
		'test_node': '/ZigbeeAPI/TestNode/', // Test node command
		'network_statistics': '/ZigbeeAPI/Run/', // Set time zone
		'post_report_api': '/ZigbeeAPI/sendZWayReport', // Post report url
		'reorg_run_url': '/ZigbeeAPI/NetworkReorganization', // Url to start reorganization
		'reorg_log_url': '/ZigbeeAPI/GetReorganizationLog', // Url to load log
		'zddx_create_url': '/ZigbeeAPI/CreateZDDX/', // Create zddx file
		'get_network_statistics': '/ZigbeeAPI/GetStatisticsData', // get network statistics
		// 'get_dsk': '/ZigbeeAPI/GetDSKCollection', // Get DSK collection,
		// 'remove_dsk': 'ZigbeeAPI/RemoveDSKEntry?id=', // Remove DSK

		// Other APIs
		'packet_log': '/ZigbeeAPI/PacketLog', // Get Packet log
		'clearPacketLog': '/ZigbeeAPI/ClearPacketLog', // Reset Statistic
		'session': '/ZAutomation/api/v1/session',
		'zigbee_list': '/Zigbee/list', // Zigbee list of dongles
		...
		'encryptionKeys': '/ZigbeeAPI/EncryptionKeys', // load image from automation storage
		...
		'zigbee_classes_url': 'storage/data/Zigbee_cmd_classes.xml', // Url to Zigbee Classes
		...
		'get_dsk': '/ZigbeeAPI/GetDSKCollection', // Get DSK collection
		'add_dsk': '/ZigbeeAPI/AddDSKEntry', // Add DSK
		'remove_dsk': '/ZigbeeAPI/RemoveDSKEntry?dsk=', // Remove DSK
		'get_dsk_provisioning_list': '/ZigbeeAPI/GetDSKProvisioningList', // Show ProvisioningList (includes only DSKs)
		'add_dsk_provisioning_list': '/ZigbeeAPI/AddDSKProvisioningEntry?dsk=', // Add DSK to ProvisioningList (Response with added DSK) GET 
		'remove_dsk_collection': '/JS/Run/saveObject("zbeedskCollection",null)', // Remove DSK collection
		'enable_smart_start': '/JS/Run/zbee.SmartStartEnable()', // enable SmartStart
